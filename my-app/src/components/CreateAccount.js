    ...
    return (
        <div>
            <div class="flex flex-wrap w-full">
                <div class="flex flex-col w-full md:w-1/2 bg-blue-50">
                ...
                <div class="w-1/2 shadow-2xl">
                    <img class="hidden object-cover w-full h-screen md:block" src="https://images.unsplash.com/photo-1611095567219-8fa7d4d8bf48?ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=751&q=80" />
                </div>
            </div>
        </div>
    );
