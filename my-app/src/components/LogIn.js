    ...
    return (
        <div>
            <div class="flex flex-wrap w-full">
                <div class="flex flex-col w-full md:w-1/2 bg-yellow-50">
                    ...
                    <div class="flex flex-col justify-center px-8 pt-8 my-auto md:justify-start md:pt-0 md:px-24 lg:px-32">
                        ...
                        <div class="pt-12 pb-12 text-center">
                            <p>
                                ...
                                <Link to='/' class="font-semibold underline ml-2">
                                    Register here.
                                </Link>
                            </p>
                        </div>
                ...
                <div class="w-1/2 shadow-2xl">
                    <img class="hidden object-cover w-full h-screen md:block" src="https://images.unsplash.com/photo-1611095562057-2e70d5bf9dee?ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" />
                </div>
            </div>
        </div>
    );
