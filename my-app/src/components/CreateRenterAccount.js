    ...
    return (
        <div>
            <div class="flex flex-wrap w-full">
                <div class="flex flex-col w-full md:w-1/2 bg-gray-50">
                            ...
                            <div class="flex flex-col pt-4 mb-12">
                                <div class="flex relative ">
                                    ...
                                    <input
                                        ...
                                        onChange={handleChanges}
                                        class=" flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" placeholder="Email" />
                                </div>
                            </div>
                ...
                <div class="w-1/2 shadow-2xl">
                    <img class="hidden object-cover w-full h-screen md:block" src="https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1952&q=80" />
                </div>
            </div>
        </div>
    );
